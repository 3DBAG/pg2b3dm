# pg2b3dm
 ...
 Example command:
 `dotnet run -- -U jliempt -d baseregisters -t 'bag3d_v21020.export_3dtiles_lod22' -p 5432 -c 'geometrie' -i 'fid' -a 'attributes' --qttable tiles.xyz_tiles --leavestable tiles.bag_tiles_3k --tileidcolumn tile_id --passfile /home/jliempt/.pgpass --maxthreads 40 --compression gzip -o 21020_lod22`
